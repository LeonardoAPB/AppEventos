...
class RegisterActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val registerButton = findViewById<Button>(R.id.button9)
    ...
    private fun registerUser() {
        ...
        val email = findViewById<EditText>(R.id.editTextTextEmailAddress3).text.toString().trim()
        ...
        val confirmPassword = findViewById<EditText>(R.id.editTextTextPassword).text.toString().trim()
        val termsAccepted = findViewById<CheckBox>(R.id.checkBox2).isChecked
    ...
    private fun setupPasswordVisibilityToggle() {
        ...
        val confirmPasswordEditText = findViewById<EditText>(R.id.editTextTextPassword)
